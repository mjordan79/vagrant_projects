...
# First of all, let's initialize a .zshrc file, both in the home dir and in the /etc/skel directory
cat << EOF > ~/zshrc_dump
...
# Dracula theme for tmux. Run CTRL + b + I inside tmux
git clone https://github.com/tmux-plugins/tpm ~/.tmux/plugins/tpm
cp -a ~/.tmux /etc/skel

# Now we can restore our original .zshrc file.
rm -f ~/.zshrc /etc/skel/.zshrc
cp ~/zshrc_dump ~/.zshrc
